...
//        color = color0 * vec4(0.5, 0.5, 0.5, 1.0);
//    }
//
//
const vs_source_glsl410 = [322]u8 {
    ...
    0x30,0x20,0x2a,0x20,0x76,0x65,0x63,0x34,0x28,0x30,0x2e,0x35,0x2c,0x20,0x30,0x2e,
    0x35,0x2c,0x20,0x30,0x2e,0x35,0x2c,0x20,0x31,0x2e,0x30,0x29,0x3b,0x0a,0x7d,0x0a,
    0x0a,0x00,
};
//
//    #version 410
...
//
//
const vs_source_glsl300es = [304]u8 {
    ...
    0x2a,0x20,0x76,0x65,0x63,0x34,0x28,0x30,0x2e,0x35,0x2c,0x20,0x30,0x2e,0x35,0x2c,
...
//        color = color0 * float4(0.5f, 0.5f, 0.5f, 1.0f);
//    }
//
...
const vs_source_hlsl5 = [795]u8 {
    ...
    0x3d,0x20,0x63,0x6f,0x6c,0x6f,0x72,0x30,0x20,0x2a,0x20,0x66,0x6c,0x6f,0x61,0x74,
    0x34,0x28,0x30,0x2e,0x35,0x66,0x2c,0x20,0x30,0x2e,0x35,0x66,0x2c,0x20,0x30,0x2e,
    0x35,0x66,0x2c,0x20,0x31,0x2e,0x30,0x66,0x29,0x3b,0x0a,0x7d,0x0a,0x0a,0x53,0x50,
    0x49,0x52,0x56,0x5f,0x43,0x72,0x6f,0x73,0x73,0x5f,0x4f,0x75,0x74,0x70,0x75,0x74,
...
//        out.color = in.color0 * float4(0.5, 0.5, 0.5, 1.0);
//        return out;
//    }
//
//
const vs_source_metal_macos = [551]u8 {
    ...
    0x6c,0x6f,0x72,0x30,0x20,0x2a,0x20,0x66,0x6c,0x6f,0x61,0x74,0x34,0x28,0x30,0x2e,
...
//      color = (x_38 * vec4f(0.5f, 0.5f, 0.5f, 1.0f));
//      return;
//    }
//
//    struct main_out {
...
const vs_source_wgsl = [831]u8 {
    ...
    0x32,0x36,0x20,0x3a,0x20,0x76,0x65,0x63,0x33,0x66,0x20,0x3d,0x20,0x70,0x6f,0x73,
    ...
    0x72,0x30,0x3b,0x0a,0x20,0x20,0x63,0x6f,0x6c,0x6f,0x72,0x20,0x3d,0x20,0x28,0x78,
    0x5f,0x33,0x38,0x20,0x2a,0x20,0x76,0x65,0x63,0x34,0x66,0x28,0x30,0x2e,0x35,0x66,
    0x2c,0x20,0x30,0x2e,0x35,0x66,0x2c,0x20,0x30,0x2e,0x35,0x66,0x2c,0x20,0x31,0x2e,
    ...
    0x6e,0x2c,0x20,0x63,0x6f,0x6c,0x6f,0x72,0x29,0x3b,0x0a,0x7d,0x0a,0x0a,0x00,
};
//
//    diagnostic(off, derivative_uniformity);
//
...
pub fn shaderGetVertexLayoutState() sg.VertexLayoutState {
    var state: sg.VertexLayoutState = .{};
    state.attrs[ATTR_shader_position].format = .FLOAT3;
    state.attrs[ATTR_shader_color0].format = .FLOAT4;
    return state;
}
pub fn shaderGetPipelineDesc(desc: sg.PipelineDesc) sg.PipelineDesc {
    var desc_ = desc;
    desc_.shader = sg.makeShader(shaderShaderDesc(sg.queryBackend()));
    desc_.layout = shaderGetVertexLayoutState();
    return desc_;
}
// HASH: 67841df81885d2a9b1792a89f4909440
